...
export const heroData=[
    {id : 1, name:'Icecream', desc : 'Chocolate Truffle', price:'80', imageSrc: I1},
    {id : 2, name:'Strawberries', desc : 'Strawberry Bonanza', price:'100', imageSrc: F1},
    {id : 3, name:'Chicken Kebab', desc : 'Mixed Kebabs', price:'200', imageSrc: C3},
    {id : 4, name:'Fish', desc : 'Fish Platter', price:'80', imageSrc: Fi1},
]
